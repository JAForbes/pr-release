...
async function rollback({ version, ignore=null }){
    ...
    let example = `
    :100644 100644 b4d8f3a3730f323a0674a38c014ffbb46ee2adaa a6e92dc2b103039fa7e5ff495ec9eefdeb02fda1 M      README.md
    :100644 100644 c91939b11b70e495842fab323e79406762a5ec45 c1ae4577541f690802a2bd21cfc071f7f428402d M      changelog.md
    :100644 100644 6453ec3411590944a123c7b1ea2cec1ab42667e3 9c61831fdd263258455b440b0c6f9713f9f918ac M      package-lock.json
    :100644 100644 df9e4075a4853d8d2aa867abc082e9b1818c6e1c 3f2eb8e965d23ff123ae7c78f85240818afdc4cf M      package.json
    `

    let x = await $`git diff-tree ${targetSHA} ${rollbackTagSHA}`
    // x = x.stdout
    x = example
    x = x.trim().split('\n')
    .map(x => x.trim())
