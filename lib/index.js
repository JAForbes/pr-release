...
async function pr(x){ 
    ...
    function updateTitle(thisRelease, version){
        return thisRelease.title
    }
    function updateBody(thisRelease, defaultBody){
        return defaultBody
    }
    ...
    if( !thisRelease ) {
        ...
        await octokit.rest.pulls.update({
            ...
            ,title: updateTitle(thisRelease, version)
